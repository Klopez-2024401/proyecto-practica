...
MONGODB_URI=mongodb://localhost:27017/proyecto_db

# URL del microservicio ms-postgre (usuarios/auth), para llamadas entre servicios
POSTGRES_API_URL=http://localhost:3007/api/v1
