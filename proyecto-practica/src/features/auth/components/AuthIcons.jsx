...
export const CheckCircleIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
    <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.5" />
    <path
      d="m8.25 12.5 2.4 2.4L15.75 9.5"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const PhoneIcon = (props) => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
    <path
      d="M6.75 3.75h3l1.2 4.2-2.1 1.5a11.5 11.5 0 0 0 5.7 5.7l1.5-2.1 4.2 1.2v3a1.5 1.5 0 0 1-1.6 1.5A16.5 16.5 0 0 1 5.25 5.35a1.5 1.5 0 0 1 1.5-1.6Z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
